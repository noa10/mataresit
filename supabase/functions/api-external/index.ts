/**
 * Mataresit External API (Alternative name to bypass middleware issues)
...
serve(async (req: Request) => {
  ...
  try {
    ...
    if (fullPath.startsWith('/api-external')) {
      endpoint = fullPath.substring('/api-external'.length);
    }
    ...
    console.error('Error in api-external function:', error);
