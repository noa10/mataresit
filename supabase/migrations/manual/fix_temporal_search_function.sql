-- Fix Temporal Search - Update unified_search function only
-- This applies the critical database function fix for temporal search
-- CORRECTED VERSION: Removed deleted_at column references
